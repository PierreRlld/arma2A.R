...
#' @param lag_max lag max à tester pour les autocorrélations des résidus (statistique de Ljung-Box) > hypothèse forte résidus suivent un bruit blanc, test jusqu'à lag_max
#'
...
TestAutocorr<-function(var,p,q,lag_max){
  autocorL<-list()
  fitdf<-p+q
